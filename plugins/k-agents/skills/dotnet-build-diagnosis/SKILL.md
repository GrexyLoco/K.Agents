...
description: Systematically diagnose and resolve .NET build errors. Use this skill for MSBuild errors, NuGet conflicts, restore issues, and build performance optimization. Based on dotnet/skills (Microsoft).
