...
# 1. OWASP Top 10 für .NET

## 1.1 Schnell-Checkliste

### 1.1.1 A01 Broken Access Control
...
### 1.1.2 A02 Cryptographic Failures
...
### 1.1.4 A05 Security Misconfiguration
...
### 1.1.5 A06 Vulnerable Components
```bash
dotnet list package --vulnerable --include-transitive
dotnet audit
```

## 1.2 PowerShell-spezifisch
